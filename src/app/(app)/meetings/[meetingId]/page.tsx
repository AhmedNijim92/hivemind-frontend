            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative">
                ...
                <div className="relative h-40 w-40 sm:h-52 sm:w-52 rounded-full overflow-hidden ring-4 ring-black/60 shadow-2xl">
                  <Avatar name={isMainSpeakerSelf ? currentUser?.name : undefined} src={isMainSpeakerSelf ? currentUser?.profilePictureUrl : undefined} size="xl" className="h-full w-full text-5xl" />
                </div>
